...
def display_optional_parameters(datamanager):
    if not datamanager.parcel_file_loaded:
        ...
        image_coverage_title_label = widgets.Label(value="VHR image coverage options:")
        ...
        consider_noncontributing_title_label = widgets.Label(value="Non-contributing parcels:")
